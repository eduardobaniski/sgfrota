...
">
    ...
    <div class="border-t border-gray-200 pt-4 mt-4 flex justify-between items-center">
        ...
        <div class="flex space-x-2">
            ...
            <a href="{{-- route('viagens.create', ['caminhao_id' => $caminhao->id]) --}}" class="flex items-center text-sm text-gray-600 hover:text-green-600 font-medium p-2 rounded-md hover:bg-gray-100 transition-colors">
