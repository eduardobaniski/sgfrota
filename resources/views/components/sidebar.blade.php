<aside class="w-64 bg-orange-300 text-black flex-shrink-0 flex flex-col">
    <div class="p-6">
    ...
    <div class="mt-auto p-4">
        <a href="/perfil" 
           class="flex items-center w-full py-2.5 px-4 rounded font-semibold transition duration-200 hover:bg-white hover:text-orange-500">
            <svg class="w-5 h-5 mr-3" xmlns="http://www.w.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
